...
@WebServlet(name = "CashierProductServlet", urlPatterns = {"/CashierProductServlet"})
@MultipartConfig(
...
public class CashierProductServlet extends HttpServlet {
    ...
    private void showNewForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/Cashier/productForm.jsp");
        dispatcher.forward(request, response);
    }
    ...
    private void insertProduct(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            if (success) {
                ...
                response.sendRedirect("CashierProductServlet?action=list");
            } else {
            ...
            response.sendRedirect("CashierProductServlet?action=new");
        }
    }
    ...
    private void updateProduct(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            response.sendRedirect("CashierProductServlet?action=edit&id=" + request.getParameter("id"));
        }
    }
