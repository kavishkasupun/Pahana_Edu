...
<div id="wrapper">
  ...
  <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    ...
    <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="${pageContext.request.contextPath}/ProductServlet?action=list" class="active">
            ...
            <div class="card-header">
              ...
              <div class="card-action">
                <div class="btn-group" role="group">
                  <a href="${pageContext.request.contextPath}/ProductServlet?action=new" class="btn btn-primary">
                  ...
                  <a href="${pageContext.request.contextPath}/ProductServlet?action=list" class="btn btn-info">
                  ...
                  <tbody>
                    <c:forEach var="product" items="${products}">
                      <tr class="${product.quantity == 0 ? 'out-of-stock' : (product.quantity <= 5 ? 'low-stock' : '')}">
                        ...
                        <td>
                          <a href="${pageContext.request.contextPath}/ProductServlet?action=edit&id=${product.productId}" 
                             class="btn btn-sm btn-warning">
                            <i class="fa fa-edit"></i>
                          </a>
                          <a href="${pageContext.request.contextPath}/ProductServlet?action=delete&id=${product.productId}" 
