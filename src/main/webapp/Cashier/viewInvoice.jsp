    ...
    <c:choose>
        <c:when test="${not empty invoice and not empty items and not empty customer}">
            <div class="invoice-container">
                ...
                <div class="action-buttons">
                    <a href="${pageContext.request.contextPath}/CashierInvoiceServlet?action=print&id=${invoice.invoiceId}" 
        ...
        <c:otherwise>
            <div class="error-container">
                ...
                <a href="${pageContext.request.contextPath}/CashierInvoiceServlet?action=list" class="btn btn-primary">
                    Back to Sales List
                </a>
            </div>
        </c:otherwise>
